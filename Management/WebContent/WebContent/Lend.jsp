				...
				<div class="banner">
					<h2>
						<a href="Home?userid=<s:property value="user.userid"/>">Home</a> <i
							class="fa fa-angle-right"></i> <span>Blank</span>
					</h2>
				</div>
				<!--//banner-->
				<!--faq-->
				<div class="blank">
					...
					<div class="blank-page">
						<form class="form" action="LendManage" method="post">
							...
							<label for="id_LendUnit">所借单位:</label> <select name=LendUnit><option
									value="CS">cs</option>
								<option value="Big Data">BigData</option>
								<option value="Welding">Welding</option>
								<option value="AI">AI</option></select></br> <br>
							<label for="id_main">申请主题:</label><input type="text"
								name="maintext" autofocus maxlength="254" required id="id_main" /></br>

							<br>
							<textarea rows="20" cols="50" name="application" required
								id="id_application" placeholder="输入你的申请，这会提交给admin审核，通过后会给予信息提醒"></textarea>
							</br> <br>
