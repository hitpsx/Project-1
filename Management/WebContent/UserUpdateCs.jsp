  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="UpdateCs" method="post">
								...
								<input type="hidden" name=EquNumber value=<s:property value="EquNumber"/> />
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Equipment ID</label>
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1" id="disabledinput" value="<s:property value="Cpt.EquNumber"/>" readonly="readonly">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Equipment name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" value="<s:property value="Cpt.EquName"/>" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="ModelSpe"  value="<s:property value="Cpt.ModelSpe"/>" >
									</div>
								</div>
							  ...
							  <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquDate"  value="<s:property value="Cpt.EquDate"/>" >
									</div>
							  </div>
							  ...
							  <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquSta"  value="<s:property value="Cpt.EquSta"/>" readonly="readonly">
									</div>
							  </div>
							  ...
							  <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquClass"  value="<s:property value="Cpt.EquClass"/>" readonly="readonly">
									</div>
							  </div>
					          ...
					          <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquSta"  value="<s:property value="Cpt.Manufacturer"/>">
									</div>
							  </div>
							  ...
							  <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Supplier"  value="<s:property value="Cpt.Supplier"/>">
									</div>
							  </div>
							  <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">OrderDate</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="OrderDate"  value="<s:property value="Cpt.OrderDate"/>">
									</div>
							  </div>
							  <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Inspector</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Inspector"  value="<s:property value="Cpt.Inspector"/>" >
									</div>
							  </div>
							  <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">InventoryPosition</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="InventoryPosition"  value="<s:property value="Cpt.InventoryPosition"/>" >
									</div>
							  </div>
							  <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">PresentPosition</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="PresentPosition"  value="<s:property value="Cpt.PresentPosition"/>" >
									</div>
							  </div>
							  <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">UnitPrice</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="UnitPrice"  value="<s:property value="Cpt.UnitPrice"/>" >
									</div>
							  </div>
							  <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Handler</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Handler"  value="<s:property value="Cpt.Handler"/>" >
									</div>
							  </div>
