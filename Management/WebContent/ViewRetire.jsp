		     ...
		     <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">				                           
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li> <s:a action="HomeLend"><s:param name="userid"> <s:property value="user.userid"/> </s:param><i class="fa fa-align-left nav_icon"></i> <span class="nav-label">Lend in</span></s:a></li>         
