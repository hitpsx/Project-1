...
<div id="wrapper">
 	...
 	<div class="blank">
        	...
        	<ul class="pagination">
			    <li><a href="ComputerHome?userid=<s:property value="user.userid"/>&EquClass=<s:property value="EquClass"/>&year=<s:property value="year"/>&page=0">&laquo;</a></li>
			     <% for(int i=0;i<10;i++){ %>
			       <li><a href="ComputerHome?userid=<s:property value="user.userid"/>&EquClass=<s:property value="EquClass"/>&year=<s:property value="year"/>&page=<%=i%>"><%=i%></a></li>
			    <%}%>
