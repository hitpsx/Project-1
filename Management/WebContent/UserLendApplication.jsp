  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="LendManage" method="post">
								...
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">Loan unit</label>
									<div class="col-sm-8"><select name="unitlend" id="selector1" class="form-control1">
										<option>AI</option>
										<option>CS</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="maintext">
									</div>
								</div>
