...
<html>
<head>
<title>Retire Application</title>
  ...
  <div class="grid-form1">
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="RetireManage" method="post">
								...
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										...
										<s:a href="HomeRetire?userid=%{user.id}"><input type="button" value="Cancel" class="btn-default btn"></s:a>
