					...
					<div class="col-md-7 mid-content-top">
						<div class="middle-content">
							...
							<div id="owl-demo" class="owl-carousel text-center">
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ1.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ2.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ3.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ4.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ5.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ6.jpg"
										alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive" data-src="images/equ7.jpg"
										alt="name">
								</div>
