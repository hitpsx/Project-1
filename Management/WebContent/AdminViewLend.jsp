...
<div id="wrapper">
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">				                           
                    ...
                    <li>
                    	<a href="#" class=" hvr-bounce-to-right"><i class="fa fa-list nav_icon"></i> <span class="nav-label">Select</span><span class="fa arrow"></span></a>
                    	 <ul class="nav nav-second-level">
	...
	<div class="gallery">
     ...
     <div class="col-md-8 profile-text">
				...
				<h6><s:property value="Le.EquName"/></h6>
				<table>
				<tr>
				<td>EquNumber</td>
				<td> :</td>
