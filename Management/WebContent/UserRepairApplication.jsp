  ...
  <div class="grid-form1">
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="RepairManage" method="post">
								...
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">Device ID</label>
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1" id="disabledinput" value="<s:property value="Cp.EquNumber"/>" readonly="readonly">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Device name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" value="<s:property value="Cp.EquName"/>" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="title" placeholder="Main idea" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Applicant" placeholder="Who made the application" >
									</div>
								</div>
							    ...
							    <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  class="form-control1"  id="datepicker"  name="ApplicationDate">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8"><textarea name="Application" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
								</div>
								
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Phone</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="Phone" placeholder="Tel" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquClass"  value="<s:property value="Cp.EquClass"/>" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="EquUnit"  value="<s:property value="Cp.EquUnit"/>" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="location" placeholder="Locationl">
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										...
										<s:a href="HomeRepair?userid=%{user.id}"><input type="button" value="Cancel" class="btn-default btn"></s:a>
										<s:a href="RetirButton?userid=%{user.id}&EquNumber=%{EquNumber}"><input type="button" value="reset" class="btn-inverse btn"></s:a>
