	...
	<div class="col-md-12 graph-box1 clearfix">	
							<div class="grid-1">
								...
								<div class="grid-graph">
									...
									<div id="os-Win-lbl">Micro-Computer <span>3264650</span></div>
									<div id="os-Mac-lbl">ORouter <span>154660</span></div>
									<div id="os-Other-lbl">Switch <span>371100</span></div>
									<div id="os-server-lbl">Server <span>0</span></div>
									<div id="os-lbl" class="os-lbl">Office-Equipment <span>67063</span></div>
								 </div>
								 </div>
							<div class="grid-2">
